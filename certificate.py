...
def save_certificate_route():
    try:
        ...
        required_fields = {
            "Birth Certificate": ["name", "date_of_birth", "place_of_birth", "father_name", "mother_name"],
            "Death Certificate": ["name", "date_of_death", "place_of_death", "cause_of_death"],
            "Land Certificate": ["property_address", "owner_name", "survey_number", "area_in_sq_ft", "market_value"],
